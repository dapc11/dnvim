...
call <sid>hi("Search",        s:gui06, s:gui03, s:cterm06, s:cterm03,  "", "")
...
call <sid>hi("LineNr",        s:gui02, s:gui00, s:cterm02, s:cterm01, "", "")
...
call <sid>hi("Statement",    s:gui0A, "", s:cterm0A, "", "", "")
...
call <sid>hi("LspDiagnosticsDefaultInformation",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("LspDiagnosticsDefaultHint",     s:gui0D, "", s:cterm0D, "", "", "")
...
call <sid>hi("LspDiagnosticsVirtualTextInformation",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("LspDiagnosticsVirtualTextHint",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("LspDiagnosticsUnderlineError",     s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("LspDiagnosticsUnderlineWarning",     s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("LspDiagnosticsUnderlineInformation",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("LspDiagnosticsUnderlineHint",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("LspDiagnosticsFloatingError",     s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("LspDiagnosticsFloatingWarning",     s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("LspDiagnosticsFloatingInformation",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("LspDiagnosticsFloatingHint",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("LspDiagnosticsSignError",     s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("LspDiagnosticsSignWarning",     s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("LspDiagnosticsSignInformation",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("LspDiagnosticsSignHint",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("DiagnosticError",     s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("DiagnosticWarning",     s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("DiagnosticInformation",     s:gui0D, "", s:cterm0D, "", "", "")
...
" gray
highlight! CmpItemAbbrDeprecated guibg=NONE gui=strikethrough guifg=#6a707e
" blue
...
highlight! CmpItemKindText guibg=NONE guifg=#56b6c2
" pink
highlight! CmpItemKindFunction guibg=NONE guifg=#c678dd
highlight! CmpItemKindMethod guibg=NONE guifg=#c678dd
" front
highlight! CmpItemKindKeyword guibg=NONE guifg=#b6bdca
highlight! CmpItemKindProperty guibg=NONE guifg=#b6bdca
highlight! CmpItemKindUnit guibg=NONE guifg=#b6bdca

highlight! TreesitterContext guibg=#353b45
